...
##
# \brief Esta classe implementa um bloco do tipo O
class BlocoO(Bloco):
    ##
    ...
    def gerarBloco(self):
        ...
        self.matriz_referencia[self.coordenadas[0]][self.coordenadas[1]] = "0"
        self.matriz_referencia[self.coordenadas[2]][self.coordenadas[3]] = "0"
        self.matriz_referencia[self.coordenadas[4]][self.coordenadas[5]] = "0"
        self.matriz_referencia[self.coordenadas[6]][self.coordenadas[7]] = "0"
        return True
    ...
    def rotacionar_esquerda(self):
        if(self.coordenadas[5] + 1 == self.coordenadas[1]):     #Caso em que a peça está deitada para a direita
            if(self.coordenadas[0] - 1 <= 0):       #Verifico se é possível girar a peça
                return False
            ...
            if(self.coordenadas[1] - 1 <= 0):    #Verifico se é possível girar a peça
                return False
            ...
            if(self.coordenadas[0] + 1 >= len(self.matriz_referencia) - 1): #Verifico se é possível girar a peça
                return False
            elif(self.matriz_referencia[self.coordenadas[0] + 1][self.coordenadas[1] + 1] != " " or self.matriz_referencia[self.coordenadas[2] + 2][self.coordenadas[3]] != " "):
                return False
            else:                                           #Atualizo as coordenadas e gero um novo bloco
            ...
            if(self.coordenadas[1] + 1 >= len(self.matriz_referencia[0]) - 1): #Verifico se é possível girar a peça
                return False
            elif(self.matriz_referencia[self.coordenadas[0] - 1][self.coordenadas[1] + 1] != " " or self.matriz_referencia[self.coordenadas[2]][self.coordenadas[3] + 2] != " "):
                return False
            else:
    ...
    def ir_baixo(self):
        ...
        if(self.coordenadas[4] + 1 == self.coordenadas[0]):
            if(self.matriz_referencia[self.coordenadas[0] + 1][self.coordenadas[1]] != " " or self.matriz_referencia[self.coordenadas[2] + 1][self.coordenadas[3]] != " "):   
            ...
            if(self.matriz_referencia[self.coordenadas[0] + 1][self.coordenadas[1]] != " " or self.matriz_referencia[self.coordenadas[4] + 1][self.coordenadas[5]] != " "):
            ...
            if(self.matriz_referencia[self.coordenadas[6] + 1][self.coordenadas[7]] != " " or self.matriz_referencia[self.coordenadas[2] + 1][self.coordenadas[3]] != " "):
                self.coordenadas = [0, 0, 0, 0, 0, 0, 0, 0]
                return False
    ...
    def ir_esquerda(self):
        if(self.coordenadas[4] + 1 == self.coordenadas[0]):                           #Caso em que está de ponta cabeça e nao podemos mover para esquerda
            if(self.matriz_referencia[self.coordenadas[6]][self.coordenadas[7] - 1] != " " or self.matriz_referencia[self.coordenadas[2]][self.coordenadas[3] - 1] != " "):   
                return False                           
                                                                                         

        elif(self.coordenadas[4] - 1 == self.coordenadas[0]):                         #Caso em que está em pé e nao podemos mover para esquerda  
            if(self.matriz_referencia[self.coordenadas[0]][self.coordenadas[1] - 1] != " " or self.matriz_referencia[self.coordenadas[4]][self.coordenadas[5] - 1] != " "):   
                return False                                        
                                                                                       
        
        elif(self.coordenadas[5] - 1 == self.coordenadas[1]):                         #Caso em que está deitado para esquerda e nao podemos mover para esquerda
            if(self.matriz_referencia[self.coordenadas[0]][self.coordenadas[1] - 1] != " " or self.matriz_referencia[self.coordenadas[2]][self.coordenadas[3] - 1] != " "):
                return False 
